          ...
          executionPromise.then(
            result => {
              if (result == false) LOG("The execution generated error ! ", id);
                ...
                LOG ( "types : " , typeof(result) , " " , typeof ( question.answer ) );
                LOG ( " final answer : " , result==question.answer )
                LOG ( "size : " , result.length , " " , question.answer.length );
                result = result.trim() ; 
                LOG ( "size after trimming : " , result.length );
